...
VBORectangle::VBORectangle(const VBORectangle& v)
{
	_shader = render->getShader();
	_vbo = 0;
	_ibo = 0;
...
VBORectangle& VBORectangle::operator=(const VBORectangle& v)
{
	for (int i = 0; i < _numVertices; i++)
	{
		vertices[i] = v.vertices[i];
...
void VBORectangle::drawClipped(fRectangle clip)
{
...
void VBORectangle::setPosition(GLfloat x, GLfloat y)
{
	presence.x = x;
	presence.y = y;
}

void VBORectangle::offsetPosition(GLfloat x, GLfloat y)
{
	presence.x += x;
	presence.y += y;
}

void VBORectangle::setSize(GLfloat w, GLfloat h)
{
	presence.w = w;
	presence.h = h;
}

void VBORectangle::setRect(fRectangle r)
{
	presence = r;
}

void VBORectangle::setRGBA(Color c)
{
	_color = c;
}

void VBORectangle::setRotation(float r)
{
	_rotation = r;
}

void VBORectangle::setTexture(GLuint t)
{
	_txr = t;
}

void VBORectangle::setWireframe(bool b)
{
	_wf = b;
}

void VBORectangle::setUI(bool b)
{
	_isUI = b;
}

void VBORectangle::setClip(fRectangle *t)
{
	_clip = *t;
}

void VBORectangle::initVBO()
{
